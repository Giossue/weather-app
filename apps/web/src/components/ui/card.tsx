...
export const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("min-w-0 rounded-2xl border bg-card text-card-foreground shadow-[0_18px_60px_rgba(15,71,80,0.08)] backdrop-blur", className)} {...props} />
));
...
export const CardFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("flex min-w-0 items-center p-5 pt-0", className)} {...props} />
));
